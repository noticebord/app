            ...
            children: <Widget>[
              ...
              Expanded(
                child: !done
                    ...
                    : ListView.builder(
                        scrollDirection: Axis.vertical,
                        itemCount: teamNotices.nextPageUrl == null
                            ? teamNotices.data.length
                            : teamNotices.data.length + 1,
                        itemBuilder: (context, position) {
                          ...
                          return Padding(
                            ...
                            child: LoadingButtonWidget(
                              ...
                              onPressed: () async {
                                ...
                                final cursor =
                                    Uri.parse(teamNotices.nextPageUrl!)
                                        .queryParameters['cursor'];
                                final notices = teamNotices.data;
                                final tNotices = await client.teamNotices
